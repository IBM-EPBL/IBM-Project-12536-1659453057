...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=fbd88901-ebdb-4a4f-a32e-9822b9fb237b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=32731;SECURITY=SSL;SSLServerCertified=DigiCertGlobalRootCA.crt;UID=jdh26008;PWD=31UZNwib5KamQwH3",'','')
print(conn)
@app.route("/")
def front():
